...
public class DatabaseManager {
    ...
    private static final String CUSTOMERS_FILE = "src/main/resources/org/example/proiect_fis/customers.json";
    private static final String EMPLOYEES_FILE = "src/main/resources/org/example/proiect_fis/employees.json";
    private static final String PRODUCTS_FILE = "src/main/resources/org/example/proiect_fis/products.json";
    private static final String ORDERS_FILE = "src/main/resources/org/example/proiect_fis/orders.json";
    private static final String PROMOTIONS_FILE = "src/main/resources/org/example/proiect_fis/promotions.json";
    private static final String SERVICE_REQUESTS_FILE = "src/main/resources/org/example/proiect_fis/service_requests.json";
    ...
    private List<Customer> loadCustomers() {
        try (InputStreamReader reader = new InputStreamReader(getClass().getResourceAsStream("/org/example/proiect_fis/customers.json"))) {
    ...
    private List<Employee> loadEmployees() {
        try (InputStreamReader reader = new InputStreamReader(getClass().getResourceAsStream("/org/example/proiect_fis/employees.json"))) {
    ...
    private List<Product> loadProducts() {
        try (InputStreamReader reader = new InputStreamReader(getClass().getResourceAsStream("/org/example/proiect_fis/products.json"))) {
    ...
    private List<Order> loadOrders() {
        try (InputStreamReader reader = new InputStreamReader(getClass().getResourceAsStream("/org/example/proiect_fis/orders.json"))) {
    ...
    private List<Promotion> loadPromotions() {
        try (InputStreamReader reader = new InputStreamReader(getClass().getResourceAsStream("/org/example/proiect_fis/promotions.json"))) {
    ...
    private List<ServiceRequest> loadServiceRequests() {
        try (InputStreamReader reader = new InputStreamReader(getClass().getResourceAsStream("/org/example/proiect_fis/service_requests.json"))) {
